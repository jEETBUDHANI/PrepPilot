  ...
  return (
    <div className={`w-full ${containerClassName}`}>
      ...
      <div className="relative flex items-center">
        ...
        <input
          className={`w-full rounded-xl border border-white/10 bg-slate-900/60 py-3 text-sm text-slate-100 placeholder:text-slate-500 outline-none backdrop-blur-md transition-all duration-200 focus:border-amber-500/80 focus:bg-slate-900/80 focus:ring-4 focus:ring-amber-500/10 ${
            Icon ? "pl-11" : "pl-4"
          } ${EndIcon ? "pr-11" : "pr-4"} ${
